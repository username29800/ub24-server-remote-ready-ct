...
ln -sf "$dpath"/Firefox/firefox/firefox menu/Firefox
...
ln -sf "$dpath"/Thunderbird/thunderbird/thunderbird menu/Thunderbird
...
ln -sf "$dpath"/Discord/Discord/discord menu/Discord
...
ln -sf "$dpath"/Seamonkey/seamonkey/seamonkey menu/Seamonkey
